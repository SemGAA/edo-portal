<section>
    <header>
        <h2 class="text-lg font-medium text-slate-900">Смена пароля</h2>
        <p class="mt-1 text-sm text-slate-600">Используйте надежный пароль для доступа к корпоративным документам.</p>
    </header>
